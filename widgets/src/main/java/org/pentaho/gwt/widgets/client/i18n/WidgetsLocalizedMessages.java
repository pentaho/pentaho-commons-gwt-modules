 ...
 * C:/development-2.0/pentaho-gwt-widgets/eclipse-bin/org
 * /pentaho/gwt/widgets/client/i18n/WidgetsLocalizedMessages.properties'.
 */
public interface WidgetsLocalizedMessages extends com.google.gwt.i18n.client.Messages {
   ...
   * 
   * @return translated
   *         "Attempt to initialize the Recurrence Dialog with an invalid CRON string: {0}. Error details: {1}."
   */
   ...
   *         "Are you sure you want to delete all checked schedules? There are {0} users subscribed to this schedule."
   */
  @DefaultMessage( "Are you sure you want to delete all checked schedules?"
      + "There are {0} users subscribed to this schedule." )
  ...
  String cronInvalidMonthValueGeneral();
