...
/**
 * Factory for creating {@link PentahoFilter}s.
 *
 * @author Jordan Ganoff (jganoff@pentaho.com)
 */
public class PentahoFilterFactory implements IPentahoFilterFactory, java.io.Serializable {


  public final PentahoFilter create( PovComponentType type ) {
    return PentahoFilter.create( type.getCdfType() );
  }
}
