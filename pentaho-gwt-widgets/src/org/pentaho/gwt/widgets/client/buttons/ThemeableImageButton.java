 ...
 * Makes use of css styles to provide the image and sizing.
 */
public class ThemeableImageButton extends Image {
  ...
  private static final String BLANK_IMAGE = GWT.getHostPageBaseURL() + "content/common-ui/resources/themes/images/spacer.gif";
